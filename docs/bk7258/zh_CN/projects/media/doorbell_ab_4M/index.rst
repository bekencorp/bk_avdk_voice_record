...
,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
    ...
    +-------------------------------------------------------------------+-----------------------------------------------+
    |part_table_tools/otherScript/special_project_deal.py               |增加针对doorbell_ab_4M分区工程的编译处理       |
    +-------------------------------------------------------------------+-----------------------------------------------+
    |CMakeLists.txt                                                     | 增加doorbell_ab_4M工程                        |
    |                                                                   |                                               |
    |part_table.mk                                                      | 增加doorbell_ab_4M编译信息                    |
    +-------------------------------------------------------------------+-----------------------------------------------+
    |media/doorbell_ab_4M/config/bk7258_cp1/config                      |增加doorbell_ab_4M工程CPU1使用的宏控           |
    |                                                                   |                                               |
    |tmedia/doorbell_ab_4M/config/bk7258_cp2/config                     |增加doorbell_ab_4M工程CPU2使用的宏控           |
    |                                                                   |                                               |
    |media/doorbell_ab_4M/config/bk7258/config                          |增加doorbell_ab_4M工程CPU0使用的宏控           |
    +-------------------------------------------------------------------+-----------------------------------------------+
