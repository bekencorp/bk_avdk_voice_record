...
,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
    ...
    <bk_avdk源代码路径>/projects/media/doorbell_4M
...
,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
    ...
    doorbell_4M与doorbell_8M的区别在于，前一个不支持DVP摄像头，还不支持板载mic。
    ...
    以下是 doorbell_8M 与doorbell_4M 的CONFIG参数区别：
     +------------------------------------+---------------------------------+---------------------------------+
     | project                            |        doorbell_8M              |          doorbell_4M            |
     +------------------------------------+---------------------------------+---------------------------------+
    ...
    | project          |          解码流程                                                                  |
    +------------------+------------------------------------------------------------------------------------+
    | doorbell_4M      |先尝试获取YUV图像，申请成功后才继续进行解码，                                       |
    |                  |lcd显示完直接触发下一次获取图像流程                                                 |
    +------------------+------------------------------------------------------------------------------------+
...
,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
    ...
    共三笔提交，注意：不包括doorbell_ab_4M工程代码的patch，代码目录核涉及文件如下表所示：
...
,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
    ...
    |multimedia/pipeline/jpeg_get_pipeline.c                            |                                       |
    +-------------------------------------------------------------------+---------------------------------------+
    |CMakeLists.txt                                                     |增加doorbell_4M工程                    |
    |                                                                   |                                       |
    |part_table.mk                                                      |                                       |
    +-------------------------------------------------------------------+---------------------------------------+
    |media/doorbell_4M/config/bk7258_cp1/config                         |使用CONFIG_MEDIA_PSRAM_SIZE_4M宏控     |
    |                                                                   |                                       |
    |media/doorbell_4M/config/bk7258_cp2/config                         |修改PSRAM分配,将USB移到CP1上运行       |
    |                                                                   |                                       |
    |media/doorbell_4M/config/bk7258/config                             |PSRAM具体修改见上面的表格              |
    +-------------------------------------------------------------------+---------------------------------------+
    |media/doorbell_4M/config/bk7258/bk7258_partitions.csv              |修改FLASH空间分配为4M                  |
    +-------------------------------------------------------------------+---------------------------------------+
