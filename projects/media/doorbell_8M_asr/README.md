## Project：doorbell_8M_asr

## Life Cycle：2023-06-16 ~~ 2023-12-06

## Application：media doorbell_8M_asr
...
## Complie Command:	
1、make bk7256 PROJECT=media/doorbell_8M_asr
...
##Audio ASR
1.If you want use wenwen_asr, open CONFIG_WENWEN_ASR and CONFIG_WENWEN_ASR_VERSION_SINGLE_MIC config\bk7258_cp2\config
2.If you want use wanson_asr, open CONFIG_WANSON_ASR and CONFIG_WANSON_ASR_WORDS_VERSION_V3   config\bk7258_cp2\config
2.If you want use wanson_asr with hi/byebye armino, open CONFIG_WANSON_ASR and CONFIG_WANSON_ASR_GROUP_VERSION and  CONFIG_WANSON_ASR_GROUP_VERSION_WORDS_V1, close CONFIG_WANSON_ASR_WORDS_VERSION_V3   config\bk7258_cp2\config
3.wenwen_asr and wanson_asr, either one or the other now.
4.Enable CONFIG_AUD_ASR on every core.
