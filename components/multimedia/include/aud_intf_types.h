...
typedef enum {
	AUD_INTF_UAC_MIC_CONNECTED,						/**< Connected: uac automatically restore connection after abnormal disconnection */
	AUD_INTF_UAC_MIC_NORMAL_DISCONNECTED,			/**< Normal disconnected: uac normal disconnection */
	AUD_INTF_UAC_MIC_ABNORMAL_DISCONNECTED,			/**< Abnormal disconnected: uac abnormal disconnection */

	AUD_INTF_UAC_SPK_CONNECTED,						/**< Connected: uac automatically restore connection after abnormal disconnection */
	AUD_INTF_UAC_SPK_NORMAL_DISCONNECTED,			/**< Normal disconnected: uac normal disconnection */
	AUD_INTF_UAC_SPK_ABNORMAL_DISCONNECTED,			/**< Abnormal disconnected: uac abnormal disconnection */
